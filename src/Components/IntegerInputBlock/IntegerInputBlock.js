...
import "./IntegerInputBlock.css";

import Overlay from "../Overlay/Overlay";

class IntegerInputBlock extends React.Component {
  constructor(props) {
    super(props);
            ...
            >
              ...
              {this.state.editPanelOpen ? (
                <Overlay
                  ...
                  mode="integer-input-block"
                  titleEL={"Επιλογές Εισόδου Ακεραίου Αρ."}
                  titleEN={"Integer Number Input Options"}
                  index={this.props.index}
...
export default IntegerInputBlock;
