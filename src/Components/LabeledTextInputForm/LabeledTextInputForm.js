...
import "./LabeledTextInputForm.css";

import LabeledInputFormEditor from "../LabeledInputFormEditor/LabeledInputFormEditor";

class LabeledTextInputForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <div className="LabeledTextInputForm">
...
export default LabeledTextInputForm;
