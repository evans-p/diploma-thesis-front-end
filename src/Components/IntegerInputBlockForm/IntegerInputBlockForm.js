...
import "./IntegerInputBlockForm.css";
...
class IntegerInputBlockForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      // The block' image.
   ...
   * "error" state object that were corrected, and after that, call "setIntegerInputBlock"
   * method, to apply the changes to the parent Component(IntegerInputBlock), then display
  ...
  handleSubmit(e) {
    ...
    this.props.setIntegerInputBlock({
  ...
  render() {
    return (
      <form className="IntegerInputBlockForm" onSubmit={this.handleSubmit}>
...
export default withSnackbar(IntegerInputBlockForm);
